...
function addBaseTree(){
    ...
    var tree = Ext.create('Ext.tree.Panel', {
       ...
       bodyPadding : 5,
       tbar: [
           {    xtype: 'button', text: '新增', handler: function(){ showAddOrEditMenu('add'); } },
           {    xtype: 'button', text: '编辑', handler: function(){ showAddOrEditMenu('edit'); }},
           {    xtype: 'button', text: '删除', handler: delEditMenu }
       ],
       listeners: {
